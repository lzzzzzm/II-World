...
class PlanningMetric():
    def __init__(self):
        ...
        self.X_BOUND = [-40.0, 40.0, 0.4]
        self.Y_BOUND = [-40.0, 40.0, 0.4]
    ...
    def get_birds_eye_view_label(
        ...
        gt_agent_boxes = gt_agent_boxes  # (N, 9)
    ...
    def _get_poly_region_in_image(self, param):
        ...
        agent_corner_cv2 = (np.matmul(lidar2cv_rot, agent_corner_lidar) \
                            - self.bev_start_position[:2, None] + self.bev_resolution[:2,
                                                                  None] / 2.0).T / self.bev_resolution[:2]  # (4,2)
    ...
    def evaluate_single_coll(self, traj, segmentation, input_gt):
        ...
        trajs_ = trajs_ / self.dx.cpu().numpy()  # (n_future, 1, 2)
        trajs_ = trajs_ + rc  # (n_future, 32, 2)
    ...
    def evaluate_coll(
        ...
        for i in range(B):
            ...
            gt_box_coll = torch.from_numpy(gt_box_coll)
            ...
            obj_box_coll_sum[ti[m2]] += (box_coll[ti[m2]])
